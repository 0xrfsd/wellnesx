...
const HomeScreen = () => {
    ...
    const Section = () => {
        return (
            <ImageBackground source={VILLA} style={{ width: '100%', height: 'auto', paddingVertical: 20 }}>
                <View
                    style={{
                        width: "100%",
                        height: "15%",
                ...
                >
                    ...
                    <TouchableOpacity style={{ height: 50, width: '100%', marginVertical: 10, borderRadius: 100, width: '80%', padding: 15, backgroundColor: '#fff', display: 'flex', flexDirection: 'row', paddingRight: '25%', justifyContent: 'space-between', alignItems: 'center' }}>
                        <FontAwesome name="search" size={20} style={{ marginLeft: 10, marginRight: 20 }} color="#cd5c5c" />
                        <Text style={{ color: '#000', fontSize: 14, fontWeight: '600' }}>Quando você vai viajar?</Text>
                    </TouchableOpacity>
                </View>
            </ImageBackground>
        );
                    ...
                    {newhouses.map((house) => (
                        <View key={house.key} style={{ marginRight: 15 }}>
                            ...
                            >
                                ...
                                >
                                    <View style={{ width: 250, display: "flex", justifyContent: 'space-between', display: 'flex', flexDirection: "row" }}>
    ...
    const VerticalView = (data) => {
        return (
            <View style={{}}>
                ...
                {newhouses.map((house) => (
                    <View key={house.key} style={{ marginRight: 15, padding: 20 }}>
                        <Pressable
                            style={{ cursor: "pointer" }}
                            onPress={() =>
                                navigation.navigate("House", {
